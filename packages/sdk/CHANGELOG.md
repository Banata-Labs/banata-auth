...
- [`fbc2b75`](https://github.com/Banata-Labs/banata-auth/commit/fbc2b75934987b1f9b033391499ca141771185e5) Thanks [@Shujaagideon](https://github.com/Shujaagideon)! - Add SDK support for updating custom roles and permissions, and align the dashboard/docs around the real role-permission assignment workflow for project-scoped RBAC.
