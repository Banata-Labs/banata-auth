...
const mainNavItems: SubNavItem[] = [
	{ label: "Methods", href: "/authentication/methods", icon: KeyRound },
	{ label: "Providers", href: "/authentication/providers", icon: Users },
	{ label: "Features", href: "/authentication/features", icon: ToggleLeft },
	{ label: "Sessions", href: "/authentication/sessions", icon: Clock },
	{ label: "Add-ons", href: "/authentication/addons", icon: Puzzle },
];
...
const relatedItems: SubNavItem[] = [
	...
	{ label: "Redirects", href: "/redirects", icon: Link2 },
];
