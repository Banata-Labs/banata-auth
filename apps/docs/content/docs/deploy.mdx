...
Record the production deployment identifier, auth API domain, hosted UI domain, dashboard/admin portal domain, and customer callback domains before routing production traffic. This evidence belongs in the `final-domain-deploy-isolation` production gate.
