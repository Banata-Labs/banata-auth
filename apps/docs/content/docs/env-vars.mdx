...
Banata Auth uses environment variables in **two separate runtimes**: the Convex backend (server-side) and the Next.js frontend. It's important to set each variable in the right place.
