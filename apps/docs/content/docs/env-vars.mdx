...
> **Self-hosted deployments only.** This page covers the environment variables required when you run your own Convex + Next.js stack. If you use Banata as a managed service, you can skip this entirely — just create a project in the dashboard, generate an API key, and integrate with [`@banata-auth/sdk`](/docs/sdk).
