...
This redirects the user to the provider's OAuth consent page. After they grant permission, they're redirected back through your callback URL, and then to the `callbackURL` you specified.
