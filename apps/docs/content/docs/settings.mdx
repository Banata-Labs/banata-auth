...
Team management is **coming soon**. Right now, the Team page shows your own account details — your name, email, and admin role.

When team management launches, you'll be able to invite other users to collaborate on your Banata Auth project with specific roles and permissions.
...
Resetting your configuration returns all dashboard settings to their defaults. This includes:
