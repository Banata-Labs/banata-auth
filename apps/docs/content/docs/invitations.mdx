  ...
  return {
    ...
    email: {
      sendInvitationEmail: async ({
        ...
        // IMPORTANT: You receive the invitation ID, not a URL.
...
> **Key difference from other callbacks:** Unlike `sendMagicLink` which gives you a ready-made `url`, the invitation callback provides the `invitationId`. You must construct the acceptance URL yourself using your `SITE_URL`.
