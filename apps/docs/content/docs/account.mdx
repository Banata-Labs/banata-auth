...
Impersonation is an administrative support tool, not a normal account-management flow. Production support sessions should be short-lived, tied to a support ticket, approved by an authorized operator, and visible in customer audit history.
