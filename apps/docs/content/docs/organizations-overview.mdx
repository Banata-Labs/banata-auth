  ...
  return {
    ...
    email: {
      sendInvitationEmail: async ({ invitation }) => {
        // invitation has: id, email, organizationId, role, inviterId
        // Note: You receive the invitationId, not a URL. Build the URL yourself:
...
// This triggers the sendInvitationEmail callback
```
