...
- `auth-security-headers`, `hosted-ui-security-headers`, and `docs-security-headers` confirm CSP, frame, MIME sniffing, referrer, and permissions headers are present.
