...
- `auth-security-headers`, `hosted-ui-security-headers`, and `docs-security-headers` confirm HSTS, CSP, frame, MIME sniffing, referrer, permissions, COOP, and CORP headers are present.
