...
| Full monorepo CI proof | `.github/workflows/ci.yml` runs `bun run verify:auth-local-readiness`; `testing/auth-production-gates.json` gate `ci-monorepo-checks`; GitHub Actions run `26253934131` passed for commit `da7db7e06e65b53ed8a883f3bc277cdf50ea0d20`; Release run `26253934129` passed for the same commit | latest launch-run evidence recorded for the readiness commit |
...
| Full monorepo test suite passes in CI | `.github/workflows/ci.yml`, `testing/auth-production-gates.json` gate `ci-monorepo-checks`, GitHub Actions run `26253934131` passed for commit `da7db7e06e65b53ed8a883f3bc277cdf50ea0d20` | latest readiness-run evidence recorded |
...
- GitHub Actions CI run `26253934131` and Release run `26253934129` passed for commit `da7db7e06e65b53ed8a883f3bc277cdf50ea0d20`.
